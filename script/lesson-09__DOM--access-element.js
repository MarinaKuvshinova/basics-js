...
let dataCol = document.querySelector('.data'),
    toolPanel = {
        buttonCalculate: document.getElementById('start'),
        buttonAddIncome: dataCol.querySelector('.income').getElementsByTagName('button')[0],
        buttonAddExpenses: dataCol.querySelector('.expenses').getElementsByTagName('button')[0],
        ...
        inputsResult: document.querySelectorAll('[class*="-value"]:not(.budget_month-value)'),
        inputSalary: dataCol.querySelector('.salary-amount'),
        inputIncomeTitle: dataCol.querySelector('.income-title'),
        inputIncomeAmount: dataCol.querySelector('.income-amount'),
        inputExpensesTitle: dataCol.querySelector('.expenses-title'),
        inputExpensesAmount: dataCol.querySelector('.expenses-amount'),
        inputAdditionalExpenses: dataCol.querySelector('.additional_expenses-item'),
        inputTargetAmount: dataCol.querySelector('.target-amount'),
        inputPeriodSelect: dataCol.querySelector('.period-select')
    };
